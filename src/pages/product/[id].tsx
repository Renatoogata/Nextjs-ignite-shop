...
export default function Product({ product }: ProductProps) {
    ...
    async function handleBuyProduct() {
        try {
            ...
            //router.push('/checkout') --> se fosse reidirecionar para uma pagina dentro  da app

            window.location.href = checkoutUrl // reidirecionar para rotas externas (vamos utilizar essa por que vai reidirecionar para o stripe)
        } catch (err) {
...
export const getStaticPaths: GetStaticPaths = async () => {
    //somente os produtos mais vendidos / acessados

    return {
        paths: [
            { params: { id: 'prod_MbOlLWeXZO8rf8' } }
        ],
        fallback: true,
    }
}
